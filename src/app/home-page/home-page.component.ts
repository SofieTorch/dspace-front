...
export class HomePageComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.siteService
      ...
      .pipe(take(1))
      .subscribe((site: Site) => {
        this.hasHomeHeaderMetadata = !isEmpty(
          site?.firstMetadataValue('cris.cms.home-header', {
  ...
  componentClass(sectionComponent: SectionComponent) {
    ...
    return isNotEmpty(sectionComponent.style) &&
      sectionComponent.style.includes('col')
      ? sectionComponent.style
      : `${defaultCol} ${sectionComponent.style}`;
  }
}
